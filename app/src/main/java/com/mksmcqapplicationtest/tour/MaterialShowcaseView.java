package com.mksmcqapplicationtest.tour;
...
import com.mksmcqapplicationtest.tour.shape.CircleShape;
import com.mksmcqapplicationtest.tour.shape.NoShape;
import com.mksmcqapplicationtest.tour.shape.RectangleShape;
import com.mksmcqapplicationtest.tour.shape.Shape;
import com.mksmcqapplicationtest.tour.target.Target;
import com.mksmcqapplicationtest.tour.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private Button mDismissButton, mSkipButton;
    ...
    private void init(Context context) {
        ...
        mSkipButton = (Button) contentView.findViewById(R.id.tv_skip);
    ...
    private void setSkipText(CharSequence dismissText) {
        if (mSkipButton != null) {
    ...
    private void setSkipStyle(Typeface dismissStyle) {
        if (mSkipButton != null) {
            mSkipButton.setTypeface(dismissStyle);
    ...
    public void setConfig(ShowcaseConfig config) {
        ...
        setSkipTextColor(config.getDismissTextColor());
        setDismissStyle(config.getDismissTextStyle());
        setSkipStyle(config.getDismissTextStyle());
    ...
    public static class Builder {
        ...
        public Builder setSkipText(CharSequence dismissText) {
            showcaseView.setSkipText(dismissText);
            return this;
        }
        ...
        public Builder setSkipStyle(Typeface dismissStyle) {
            showcaseView.setSkipStyle(dismissStyle);
            return this;
        }
