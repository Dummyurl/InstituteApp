...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileAdapter.TestViewHolder> {
    Context context;
    Typeface font1;
    String Feild;
    String Feild_User;
    ...
    public ProfileAdapter(Context context, String Feild, String Feild_User, int Font) {
    ...
    public TestViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.profile_detail, parent, false);
    ...
    public void onBindViewHolder(final TestViewHolder holder, int position) {
        try {
            ...
            holder.txt_Feild.setText(Feild_User.toLowerCase() == "null" ? "" : Feild_User);
        } catch (Exception ex) {
            PrintCatchException pc = new PrintCatchException(context,itemView, "ProfileAdapter", "onBindViewHolder", ex);
    ...
    class TestViewHolder extends RecyclerView.ViewHolder {
        ...
        public TestViewHolder(View itemView) {
            ...
            try {
                ...
                PrintCatchException pc = new PrintCatchException(context,itemView, "ProfileAdapter", "TestViewHolder", e);
                pc.showCatchException();
            }
        }
