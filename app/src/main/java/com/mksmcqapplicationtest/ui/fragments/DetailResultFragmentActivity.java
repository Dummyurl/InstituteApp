...
import com.mksmcqapplicationtest.ui.fragments.ui.adapter.QuestionwiseResultAdapter;
...
//                return true;
    ...
    public void onResponse(Object data) {
        try {
            ...
            if (questions.size() > 0) {
                QuestionwiseResultAdapter adapter = new QuestionwiseResultAdapter(questions, NegativeMark);
