...
public class TabEnableTheoryTest extends Fragment implements View.OnClickListener, SearchView.OnQueryTextListener ,ResponseListener{
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                    if (isChecked) {
                        if (datas.size() > 0) {
                            ...
                            Snackbar.make(view, "No Theory Test Available For Enable", Snackbar.LENGTH_LONG).show();
                        }
                    } else {
                        if (datas.size() > 0) {
                            ...
                            Snackbar.make(view, "No Theory Test Available For Disable", Snackbar.LENGTH_LONG).show();
                        }
                    }
                }
            });
        } catch (Exception e) {
            PrintCatchException pc = new PrintCatchException(getContext(), view, "EnableData", "OnCreate", e);
    ...
    private void NetWorkCallForClass() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "EnableData", "NetWorkCallForClass", e);
            pc.showCatchException();
        }
    }
    ...
    private void NetworkCallForAllData() {
        try {
            GetDataJSONString = new CreateJsonFunction().CreateJSONForGetData(ClassCodeForNetworkcall, "all", "0");
            DataAccess dataAccess = new DataAccess(getContext(), this);
            dataAccess.getClassData(GetDataJSONString, AppUtility.GET_DATA_OF_CLASS);
        } catch (Exception e) {
            PrintCatchException pc = new PrintCatchException(getContext(),view, "EnableData", "NetworkCallForAllData", e);
            pc.showCatchException();
        }
    }
        ...
        try {
            if (datas.size() > 0) {
                ...
                for (int i = 0; i < datas.size(); i++) {
                    String abc = datas.get(i).getAcFlag();
                    if (abc != null) {
                        JSONObject student1 = new JSONObject();
                        try {
                            student1.put("DataCode", datas.get(i).getDataCode());
                            student1.put("AcFlag", datas.get(i).getAcFlag());
                            student1.put("UserName", AppUtility.KEY_USERNAME);
                        } catch (JSONException e) {
                            PrintCatchException pc = new PrintCatchException(getContext(),view, "EnableData", "CreateJSONForEnableDisableData", e);
                            pc.showCatchException();
                        }
                ...
                dataAcess.EnableDisableData(String.valueOf(jsonArray), AppUtility.ENABLE_DISABLE_DATA);
            } else {
                Snackbar.make(view, "Something went wrong", Snackbar.LENGTH_LONG).show();
            }
        } catch (Exception ex) {
            PrintCatchException pc = new PrintCatchException(getContext(),view, "EnableData", "CreateJSONForEnableDisableData", ex);
            pc.showCatchException();
        }
    }
    ...
    private void NetWorkCallForSendNotification() {
        try {
            String NotificatioTitle = "New Theory Test";
            String NotivationText = "For " + ClassNameForNetworkCall + " New Theory Test Is Live"+ '\n' + "Regards," + '\n' + AppUtility.App_Name+"."+"";
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "EnableData", "NetWorkCallForSendNotification", e);
            pc.showCatchException();
        }
    }
                ...
                case 140:
                    ...
                    try {
                        ...
                        if (datas.get(0).getResultCode().equals("1")) {
                            activeUserListAdapter = new DataEnableAdapter(getContext(), recyclerViewOfEnableData, datas);
    ...
    public void noResponse(String error) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "EnableData", "noResponse", e);
            pc.showCatchException();
        }
    }
    ...
    public void onClick(View view) {
        try {
            switch (view.getId()) {
                case R.id.btnMakeEnable:
                    ...
                    if (ClassCodeForNetworkcall.equals("0")) {
                        ...
                        txtTitle.setText("Confirmation!!");
                        TextView txtMessage = (TextView) dialog.findViewById(R.id.text_dialog2);
                        txtMessage.setText("Are you sure? You want to active/deactive theory test");
                        final Button dialogButton = (Button) dialog.findViewById(R.id.Okbtn_dialog);
                        dialogButton.setText("Yes");
                        dialogButton.setOnClickListener(new View.OnClickListener() {
                            @Override
            ...
            PrintCatchException pc = new PrintCatchException(getContext(), view, "EnableData", "onClick", e);
            pc.showCatchException();
        }
    }
    ...
    public boolean onQueryTextSubmit(String newText) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(), view, "TabEnableTheoryTest", "onQueryTextSubmit", e);
            pc.showCatchException();
        }
        return false;
    }
    ...
    public boolean onQueryTextChange(String newText) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(), view, "TabEnableTheoryTest", "onQueryTextChange", e);
            pc.showCatchException();
        }
        return false;
    }
