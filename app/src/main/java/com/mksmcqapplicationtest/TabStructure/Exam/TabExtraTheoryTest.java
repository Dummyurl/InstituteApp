...
public class TabExtraTheoryTest extends Fragment implements ResponseListener, SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "OnCreate", e);
    ...
    private void NetWorkCallForClass() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "NetWorkCallForClass", e);
            pc.showCatchException();
        }
    }
    ...
    private void NetWorkCall() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "NetWorkCall", e);
            pc.showCatchException();
        }
    }
    ...
    private void NeteorkCallForGuest() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "NeteorkCallForGuest", e);
            pc.showCatchException();
        }
    }
    ...
    private void CreateJSON() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "CreateJSON", e);
            pc.showCatchException();
        }
    }
    ...
    private void NeteorkCallForTeacherStud() {
        try {
            ClassDataJSONString = new CreateJsonFunction().CreateJSONForGetData(ClassCodeForNetworkcall, "active", "1");
            DataAccess dataAccess = new DataAccess(getContext(), this);
            dataAccess.getClassData(ClassDataJSONString, AppUtility.GET_DATA_OF_CLASS);
        } catch (Exception e) {
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "NeteorkCallForTeacherStud", e);
            pc.showCatchException();
        }
    }
...
//                            editor.commit();
    ...
    public void noResponse(String error) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "noResponse", e);
            pc.showCatchException();
        }
    }
 ...
 NetWorkCallForClass();
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "CheckForUserType", e);
            pc.showCatchException();
        }
    }
...
//            interstitialAdvertiesClass.showInterstitialAdver();
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "ExtraTheoryTestActivity", "ShowAdvertisement", e);
            pc.showCatchException();
        }
    }
    ...
    public boolean onQueryTextSubmit(String newText) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "TabExtraTheoryTest", "onQueryTextSubmit", e);
            pc.showCatchException();
        }
        return false;
    }
    ...
    public boolean onQueryTextChange(String newText) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "TabExtraTheoryTest", "onQueryTextChange", e);
            pc.showCatchException();
        }
        return false;
    }
