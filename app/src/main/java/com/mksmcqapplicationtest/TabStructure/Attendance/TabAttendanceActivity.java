...
public class TabAttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            arrayList = new CreateArrayList().getAttendanceArrayList(GroupCode);
            ...
            PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabAttendanceActivity", "OnCreate", e);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            try {
                ...
                switch (code) {
                    case "8":
                        TabShowAttendance tab1 = new TabShowAttendance();
                        return tab1;
                    case "9":
                        TabMarkAttendance tab2 = new TabMarkAttendance();
                        return tab2;
                    case "10":
                        TabDayWiseReport tab3 = new TabDayWiseReport();
                        return tab3;
                    default:
                        TabShowAttendance tab11 = new TabShowAttendance();
                        return tab11;
                }
            } catch (Exception e) {
                PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabAttendanceActivity", "getItem", e);
                pc.showCatchException();
                return null;
            }
        ...
        private String getPositionName(int position) {
            try {
                ...
                PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabAttendanceActivity", "getPositionName", e);
                pc.showCatchException();
                return "";
            }
        }
        private String getChildCode(int position) {
            try {
                ...
                PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabExamActivity", "getPositionName", e);
                pc.showCatchException();
                return "";
            }
        }
        ...
        public int getCount() {
            try {
                ...
                PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabAttendanceActivity", "getCount", e);
                pc.showCatchException();
                return 0;
            }
        }
    ...
    private void Advertise() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabAttendanceActivity", "Advertise", e);
            pc.showCatchException();
        }
    ...
    private void ShowAdvertisement() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(TabAttendanceActivity.this,view, "TabAttendanceActivity", "ShowAdvertisement", e);
            pc.showCatchException();
        }
    }
}
