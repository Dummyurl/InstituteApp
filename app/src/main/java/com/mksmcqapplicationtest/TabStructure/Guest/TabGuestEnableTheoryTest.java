...
public class TabGuestEnableTheoryTest extends Fragment implements View.OnClickListener,  SearchView.OnQueryTextListener ,ResponseListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "onCreate", e);
    ...
    private void setUI() {
       ...
       CustomTextViewBold txtactionbartitle =  getActivity().findViewById(R.id.txtactionbartitle);
        txtactionbartitle.setText(getResources().getString(R.string.Theory_Data_Exam));
    ...
    private void NetWorkCallForClass() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "NetWorkCallForClass", e);
            pc.showCatchException();
        }
    }
    ...
    private void NetworkCallForAllData() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "NetworkCallForAllData", e);
            pc.showCatchException();
        }
    }
    ...
    private void CreateJsonForNetworkCallOfData() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "CreateJsonForNetworkCallOfData", e);
            pc.showCatchException();
        }
    }
    ...
    private void CreateJSONForEnableDisableData() {
        try {
                ...
                for (int i = 0; i < datas.size(); i++) {
                    ...
                    if (abc != null) {
                        ...
                        try {
                            ...
                            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "CreateJSONForEnableDisableData", e);
                            pc.showCatchException();
                        }
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "CreateJSONForEnableDisableData", ex);
            pc.showCatchException();
        }
    }
    ...
    private void NetWorkCallForSendNotification() {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "NetWorkCallForSendNotification", e);
            pc.showCatchException();
        }
    }
            ...
            switch (requestCode) {
                case 360:
                    ...
                    try {
                        ...
                        if (dataa.get(0).getResult().equals("Suessfull")) {
                        ...
                        } else if (dataa.get(0).getResult().equals("No Data Found")) {
                            ShowErrorPopUp showErrorPopUp=new ShowErrorPopUp();
                            showErrorPopUp.ShowPopUp(getContext(),"Error",dataa.get(0).getResult().toString());
                        } else if (dataa.get(0).getResult().equals("Something Went Wrong Please Try Again")) {
                            ShowErrorPopUp showErrorPopUp=new ShowErrorPopUp();
                            showErrorPopUp.ShowPopUp(getContext(),"Error",dataa.get(0).getResult().toString());
                        }
                    } catch (Exception ex) {
    ...
    public void onClick(View view) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "GuestEnableData", "onClick", e);
            pc.showCatchException();
        }
    }
    ...
    public boolean onQueryTextSubmit(String newText) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "TabGuestEnableTheoryTest", "onQueryTextSubmit", e);
            pc.showCatchException();
        }
        return false;
    }
    ...
    public boolean onQueryTextChange(String newText) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(getContext(),view, "TabGuestEnableTheoryTest", "onQueryTextChange", e);
            pc.showCatchException();
        }
        return false;
    }
