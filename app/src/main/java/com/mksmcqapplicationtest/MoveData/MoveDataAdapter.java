package com.mksmcqapplicationtest.MoveData;
...
public class MoveDataAdapter extends RecyclerView.Adapter<MoveDataAdapter.MyViewHolder> {
    Context context;
    ...
    public MoveDataAdapter(Context context, RecyclerView recyclerView, List<Data> datas) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            try {
                ...
                PrintCatchException pc = new PrintCatchException(context,itemView, "MoveDataAdapter", "onBindViewHolder", e);
                pc.showCatchException();
            }
            ...
            holder.chkactiveuserCheck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked) {
                        datas.get(finalPostion).setIsSelected("Y");
                    } else {
                        datas.get(finalPostion).setIsSelected("N");
                    }
                }
            });
            if (datas.get(position).getIsSelected() != null) {
                String ActiveStatus = datas.get(position).getIsSelected().toString();
    ...
    public void setFilter(List<Data> testnewlist) {
        try {
            ...
            PrintCatchException pc = new PrintCatchException(context,itemView, "MoveDataAdapter", "setFilter", e);
            pc.showCatchException();
        }
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            try {
                ...
                PrintCatchException pc = new PrintCatchException(context,itemView, "MoveDataAdapter", "MyViewHolder", e);
                pc.showCatchException();
            }
        }
